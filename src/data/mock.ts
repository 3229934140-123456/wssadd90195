...
export const approvalRecords: ApprovalRecord[] = [
  ...
  },
  {
    ...
    supervisorId: 'c4',
    status: 'needs_more',
    comment: '请补充高龄客户风险告知确认书照片，以及家属代付确认书',
    planAmount: 80000,
    giftRatio: 0.15,
    riskLevel: 'red',
...
export const rechargePlans: RechargePlan[] = [
  ...
  },
  {
    ...
    payerName: '孙女士之子',
    payerRelationDetail: '客户儿子代为支付，已电话确认代付意愿，签署代付确认书',
    riskLevel: 'red',
    riskDetails: [
      ...
      { type: '亲友代付', level: 'yellow', message: '付款人为家属，需签署代付确认书', rule: '亲友代付需填写代付关系并签署确认书' },
    ],
...
export const traceEvents: TraceEvent[] = [
  {
    ...
    content: '提交了储值方案（¥80,000 · 赠15%）',
    details: '绑定项目：热玛吉、超声刀',
  },
  {
    id: 'te2',
    planId: 'rp2',
    ...
    operator: '系统',
    operatorRole: '系统',
    timestamp: '2026-06-22T09:15:01',
    content: '检测到高风险（高龄客户+大额现金+亲友代付），自动提交主管审批',
  },
  {
    id: 'te3',
    planId: 'rp2',
    customerId: 'cu2',
    type: 'approval_needs_more',
    operator: '陈佳琪',
    operatorRole: '主管',
    timestamp: '2026-06-22T10:00:00',
    content: '主管要求补充材料',
    details: '请补充高龄客户风险告知确认书照片，以及家属代付确认书',
  },
];
